...
# UNetはこちらを利用しています
from modules import UNet,conditional_diffusion_0406,conditional_diffusion_0407_sum,conditional_diffusion_0407_sum_and_cat,Vae_Model,Encoder,Decoder,vae_loss_function
    ...
    if params.learning == 1:
        ...
        for epoch in epoch_bar:
            ...
            for iter, (x,y,vx,vy) in enumerate(dataloader):
                ...
                out,mean,log_var = model(x,device)
                loss = loss_fn(x,out,mean,log_var)#ノイズと予測したノイズの誤差を計算
...
class HyperParameters:
    ...
    output_path: str = "vae_0408" #出力先のフォルダ名
