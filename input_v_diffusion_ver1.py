...
# UNetはこちらを利用しています
from modules import UNet,conditional_diffusion_0406,conditional_diffusion_0407_sum,conditional_diffusion_0407_sum_and_cat,Input_VModel
...
class HyperParameters:
    ...
    output_path: str = "input_v_0502_train_ver11_to_20" #出力先のフォルダ名
    message: str = "ノイズレベルを下げて速度を入力にして学習。ノイズレベルを下げる(1/100)ことで最大ノイズを2.0e-4にしている" #学習内容
